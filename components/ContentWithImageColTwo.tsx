...
const ContentWithImageColTwo: React.FC<contentWithImageProps> = ({ data }) => {
  ...
  return (
    <>
      <section
        className={`${paddinglargebottom === true ? 'padding-large-bottom' : ''} ${
        ...
        <div className="container">
          <div
            ...
            <div
              ...
              {subtitle && <h6 className={` text-[#8000FF] uppercase font-normal`}>{subtitle}</h6>}
              {title && (
                <h2 className={` font-medium xl-up:text-[45px] text-black mb-[30px] md:mb-[15px] `}>{title}</h2>
              )}
