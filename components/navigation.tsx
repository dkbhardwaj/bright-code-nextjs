...
const Navigation: React.FC<NavigationProps> = () => {
  ...
  return (
    <header className={`${Style.header} py-[48px] absolute w-full top-0 left-0 z-50 lg:py-5`}>
      <div className="container">
        <div className={`${Style.mainRow} flex items-center justify-between`}>
          ...
          <div className={`${Style.links} ${Style.mobileMenu} lg:flex lg:justify-end`}>
            ...
            <div className={`header-menu ${ showMobileMenu ? 'lg:left-0' : 'lg:!-left-[calc(100vw+500px)]' } relative lg:fixed border-none lg:left-0 lg:top-0 lg:!w-[calc(100vw+500px)] lg:h-[100vh] lg:bg-[#00000066] lg:transition-all lg:duration-1000`}>
            <div className={`navbar-wrap relative lg:absolute lg:left-0 lg:top-0 lg:!w-[350px] lg:h-[100vh] lg:overflow-y-scroll lg:scroll-smooth z-10 lg:bg-white  lg:py-5 `}>
            <div className={`${Style.logo_wrapper} hidden relative w-full py-5 px-3 mb-7 lg:!flex bg-darkGray flex-wrap items-center justify-between `}>
            ...
            <div className={`${Style.close} hidden lg:!flex`} onClick={handleMobileMenuCloseClick}>X</div>
            </div>
            <ul
              ...
              <li
                className={`${Style.menu} ${isActive(
                  '/'
                )} mx-[22px]  transition-color duration-300 desktop:mx-4 lg:w-full lg:mx-0 lg:py-3 lg:text-spaceBlack lg:border-b-2 lg:border-extraLightGray lg:mb-2`}>
                <Link
              ...
              >
                ...
                <Link
                  href="/contact"
                  className={`${Style.btn} ml-[30px] gradient-btn border-btn lg:ml-0 lg:my-8 `}>
                  <span>Contact</span>
                </Link>
                {/* <Link
                  href="/contact"
