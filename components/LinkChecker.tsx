    ...
    return (
      <div className="section_bgImage bg-darkBlue py-[120px] linkChecker">
          ...
          <div className="container">
            <div className="formWrapper bgPurpleGradient py-[50px]">
              ...
              >
                ...
                <button
                  type="submit"
                  className="gradient-btn mb-[22px] md:mx-0 mx-auto"
                >
                  <span>Check</span>
                </button>
              </form>
        ...
        {showResult && loading ? (
          ...
          <section
            className={`resultWrap  flex pt-[50px] pb-[100px] md:pt-0 ${
              showResult ? "black" : "hidden"
            }`}
          >
            <div
              className={`showMenu cursor-pointer py-[10px] px-[20px] bg-black fixed text-white top-[70px] md:block hidden`}
              onClick={() => menuHandler()}
            >
              {showSideBar ? "Hide Menu" : "show Menu"}
            </div>
            <div
              className={`sidebarWrap max-w-[230px] p-[20px] bg-bgBluePurple h-[100vh] rounded-r-[20px] ${
                showSideBar ? "md:left-0" : "md:left-[-100%]"
              } transition-all ease-in-out duration-700 relative md:max-w-full md:absolute md:z-[99]`}
            >
                  ...
                  <ul>
                    ...
                    >
                      <p className="text-white ">
                        Overview
                        <span className="block text-white text-[12px]">
                          Summary of the key results of the link check.
                        </span>
                      </p>
                    </li>
                    <li
                      className={`p-[10px] ${showTab == 2 ? "bg-black" : ""}`}
                      onClick={() => tabHandler(2)}
                    >
                      <p className="text-white ">All Links</p>
                    </li>
                    <li className="p-[10px]">
                      <p className="text-white border-b-[2px] border-black">
                        Issues
                      </p>
            ...
            <div className="fullPage w-[calc(100%-360px)] ml-[50px] desktop:w-[calc(100%-300px)] tablet:w-[calc(100%-300px)] md:w-full md:mx-[20px]">
              ...
              <div
                className={`cardWrap flex w-[calc(100%+20px)] ml-[-10px] flex-wrap ${
                  showTab == 0 ? "block" : "hidden"
                }`}
              >
                ...
                <div className="card w-full mx-[10px] bg-bgBluePurple rounded-[8px] relative mb-[20px] p-[10px]">
                  <div className="linksWraps">
                    <table>
                      <thead>
                        <tr>
                          <th className="w-[150px] text-left py-[10px]">
                            Result
                          </th>
                      ...
                      <tbody>
                        <tr className="">
                          <td className="w-[150px] text-left text-white py-[5px]">
                            Ok
                          </td>
                          <td>
                            <Link href="" className="text-white py-[5px]">
                              https://healtraumas.vercel.app/
                            </Link>
                          </td>
                        </tr>
                        <tr>
