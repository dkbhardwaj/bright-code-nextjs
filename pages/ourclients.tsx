        ...
        <div className="container">
          <div className="w-mainRow -ml-2.5 py-16 flex flex-row-reverse items-center z-1 relative md:flex-wrap md:w-full md:ml-0 md:py-12">
            <div
              ...
              data-aos-delay="500"
              data-aos-duration="1000">
              <h6 className="text-[#8000FF] uppercase font-normal mb-4 md:mb-1">Colaboration</h6>
              <h2 className="font-medium xl-up:text-[45px] text-black mb-6">Agency to Agency</h2>
              <p className="mt-5 text-black">
                Our agency thrives on the synergy of collaboration. We step into the role of your dedicated development
                partner, filling a crucial gap in their service offerings.
              </p>
              <p className="mt-5 text-black">
                While design agencies excel in crafting visually stunning concepts, the seamless execution of these
                visions requires the technical prowess of a dedicated development team.
              </p>
              <p className="mt-5 text-black">
                Bright Code becomes the bridge that connects these two realms, ensuring that the synergy between
                creativity and technical implementation is not just maintained but elevated.
              </p>
            </div>
        ...
        <div className="container">
          <div className="w-full z-1 relative">
            <div
              ...
              data-aos-delay="500"
              data-aos-duration="1000">
              <h6 className="title text-[#8000FF] uppercase font-normal mb-3 md:mb-1">Our Commitment to Trust and Confidentiality</h6>
              <h2  className="font-medium text-black mb-[38px]  md:mb-4" >How we work</h2>
            </div>
            <div
              className="content w-full text-center relative"
              data-aos="fade-left"
              ...
              <h5 className="text-black font-light">
                At Bright Code, our fundamental mission is to empower our clients to deliver remarkable digital
                solutions and exceed the expectations of their end clients. We believe in the power of collaboration,
                and our role as a trusted partner reflects our commitment to our clients and their needs.
              </h5>
              <h5 className="mt-5 text-black font-light  md:mt-3">
                You may have noticed that we do not showcase our clients or their projects on our website. This choice
                is intentional and reflects our unwavering dedication to two key principles: trust and confidentiality.
              </h5>
            </div>
          </div>
        </div>
          ...
          <div className="w-mainRow -ml-2.5  py-16 flex items-center z-1 relative md:flex-wrap md:w-full md:ml-0 md:py-12">
            <div
              ...
              <p className="mt-5 text-black">
                ...
                to act professionally and discreetly as we join forces to bring their projects to life.
              </p>
              <p className="mt-5 text-black">
                Maintaining the highest ethical standards is of utmost importance to us.
              </p>
            </div>
            <div className="content imageWrap-outer w-halfWidth mx-2.5 md:w-full md:mx-0">
              <div
        ...
        <div className="container">
          <div className="w-mainRow -ml-2.5 py-16 flex flex-row-reverse items-center z-1 relative md:flex-wrap md:w-full md:ml-0  featured md:py-12">
            <div
              ...
              data-aos-delay="500"
              data-aos-duration="1000">
              <h6 className="text-[#8000FF] uppercase font-normal mb-4 md:mb-1">About Us</h6>
        ...
        <div className="container">
          <div className="w-mainRow -ml-2.5  py-16 flex items-center z-1 relative md:flex-wrap md:w-full md:ml-0 md:py-12">
            <div
              ...
              <p className="mt-5 text-black">
                Although we do not showcase specific client names or project details, we remain committed to
