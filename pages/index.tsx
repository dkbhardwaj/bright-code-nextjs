    ...
    <>
      ...
      <section
       ...
       <div className="right_img absolute bottom-0 left-[62%] w-full max-w-[538px] h-[536px] z-[1] desktop:max-w-[450px] desktop:h-[450px]  tablet:max-w-[400px] tablet:h-[400px] xl:left-[65%] md:h-[310px] md:max-w-[325px] md:!left-auto md:right-[calc(35%-200px)] ">
        <Image src="/home/banner-right-img.png" width={550} height={550} alt="right-img"  className=" w-full h-full object-cover" />
       </div>
       <div className="left_img absolute bottom-0 right-[61%] w-full max-w-[526px] h-[506px] z-[1] desktop:max-w-[450px] desktop:h-[450px]  tablet:max-w-[400px] tablet:h-[400px] xl:right-[65%] md:h-[310px] md:max-w-[325px] md:!right-[35%] ">
        <Image src="/home/banner-left-img.png" width={550} height={550} alt="left-img"  className=" w-full h-full object-cover" />
       </div>
        <div className="container">
          <div className="w-full max-w-[574px] mx-auto relative z-[2] text-center">
            <h1 className="header-h1" data-aos="fade-left"
              data-aos-delay="400"
              data-aos-duration="500">
              Empowering Designers, Thrilling Clients.
            </h1>
            <Link href="/whychooseus" className=" mt-14 gradient-btn mx-auto md:mt-6" data-aos="fade-right"
              data-aos-delay="300"
              data-aos-duration="300"><span>Get Started</span></Link>
          </div>
        </div>
      </section>
      {/* Banner End */}
      ...
      >
        <div className="container">
          <div className="w-full mx-auto">
            ...
            <h2 className="font-medium text-black mb-[38px] md:mb-[20px] ">Our agency-to-agency model is built on <br />
            <span className="text_gradient text-[50px] leading-[65px] desktop:text-[36px] desktop:leading-[60px] tablet:text-[33px] tablet:leading-[55px] md:text-[30px] md:leading-[50px] ">collaboration and
              expertise.</span>
              </h2>
            <h5 className="text-black w-full max-w-[960px] mx-auto">
              As a specialized development agency, our core purpose
      ...
      <section className="introWithCards pb-20 md:pb-10">
        <div className="container">
          <div className="w-mainRow -ml-2.5 flex flex-wrap sm:w-full sm:ml-0">
              ...
              <div className="card bg-white h-full ">
                <div className="relative imageWrap group h-[260px] tablet:h-[220px] phablet:h-[220px] sm:h-[200px] overflow-hidden rounded-[30px]  before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-transparent before:border-bordergradient before:border-[7px] before:z-10 before:border-solid before:rounded-[30px]">
                  ...
                  <Image
                    ...
                    src="/home/col-three-img1.png"  width={400} height={300}
            ...
            >
              <div className="card bg-white h-full">
                <div className="relative imageWrap group h-[260px] tablet:h-[220px] phablet:h-[220px] sm:h-[200px] overflow-hidden rounded-[30px]  before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-transparent before:border-bordergradient before:border-[7px] before:z-10 before:border-solid before:rounded-[30px]">
                  ...
                  <Image
                    className="object-cover transition-transform duration-300 group-hover:scale-105 h-full w-full"
                    src="/home/col-three-img2.png"  width={400} height={300}
                ...
                <div  className="textWrap py-9 px-5 text-center md:p-5">
                  ...
                  <span className="text-gray font-light mt-[30px] line-clamp-4 text-ellipsis  text-[15px] leading-[26px] md:text-[14px] md:leading-[22px] md:mt-4 ">
                  We know that clients are your ultimate consideration. We ensure that the websites we develop not only meet but exceed the end-users needs.
                  </span>
                </div>
              </div>
            </div>
            ...
            >
              <div className="card bg-white h-full">
                <div className="relative imageWrap group h-[260px] tablet:h-[220px] phablet:h-[220px] sm:h-[200px] overflow-hidden rounded-[30px]  before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-transparent before:border-bordergradient before:border-[7px] before:z-10 before:border-solid before:rounded-[30px]">
                  ...
                  <Image
                    className="object-cover transition-transform duration-300 group-hover:scale-105 h-full w-full"
                    src="/home/col-three-img3.png"  width={400} height={300}
            ...
            <Link href="/whychooseus" className=" mt-7 gradient-btn mx-auto"><span>Learn More</span></Link>
          </div>
        </div>
      </section>
      ...
      >
        <div className="container">
          <div className="w-full max-w-[600px] mx-auto">
            <h2 className="text-black text-[65px] font-semibold desktop:text-[42px] tablet:text-[36px] md:text-[32px]">What we do</h2>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="w-mainRow -ml-2.5 py-16 flex flex-row-reverse items-center z-1 relative md:flex-wrap md:w-full md:ml-0 md:py-12">
            <div
              ...
              data-aos-duration="500"
            >
              <h3><span className="text_gradient text-[35px] leading-[46px] tablet:text-[30px] tablet:leading-[42px] md:text-[27px] md:leading-[40px]">White Label Development</span></h3>
              ...
              <Link href="/white-label-development" className=" mt-5 bgWhiteBtn gradient-btn mx-auto"><span>Learn More</span></Link>
            </div>
            <div className="content imageWrap-outer w-halfWidth mx-2.5 md:w-full md:mx-0">
              <div
                ...
                data-aos-duration="500"
              >
                <Image src="/home/col-two-img1.png" alt="White Label Developments" width={600} height={500} className=" w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="w-mainRow -ml-2.5 py-16 flex items-center z-1 relative md:flex-wrap md:w-full md:ml-0 featured  md:py-12">
            <div
              ...
              data-aos-duration="500"
            >
              <h3><span className="text_gradient text-[35px] leading-[46px] tablet:text-[30px] tablet:leading-[42px] md:text-[27px] md:leading-[40px]">Dedicated Development Teams</span></h3>
              <p className="mt-5  text-black">
              ...
              <Link href="/dedicated-team" className=" mt-5 bgWhiteBtn gradient-btn mx-auto"><span>Learn More</span></Link>
            </div>
            <div className="content imageWrap-outer w-halfWidth mx-2.5 md:w-full md:mx-0">
              <div
                className="imageWrap w-full  h-[458px] tablet:h-[280px] sm:h-[260px]  relative overflow-hidden rounded-[30px]  before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-transparent before:border-bordergradient2 before:border-[7px] before:z-10 before:border-solid before:rounded-[30px]"
                ...
                data-aos-duration="500"
              >
                <Image src="/home/col-two-img2.png" alt="girl" width={600} height={500}  className=" w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="w-mainRow -ml-2.5 py-16 flex flex-row-reverse items-center z-1 relative md:flex-wrap md:w-full md:ml-0  md:py-12">
            <div
              ...
              data-aos-duration="500"
            >
              <h3><span className="text_gradient text-[35px] leading-[46px] tablet:text-[30px] tablet:leading-[42px] md:text-[27px] md:leading-[40px]">CMS Implementation</span></h3>
              <p className="mt-5  text-black">
              ...
              <Link href="/cms-implementation" className=" mt-5 bgWhiteBtn gradient-btn mx-auto"><span>Learn More</span></Link>
            </div>
            <div className="content imageWrap-outer w-halfWidth mx-2.5 md:w-full md:mx-0">
              <div
                className="imageWrap w-full  h-[458px] tablet:h-[280px] sm:h-[260px]  relative overflow-hidden rounded-[30px]  before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-transparent before:border-bordergradient2 before:border-[7px] before:z-10 before:border-solid before:rounded-[30px]"
                ...
                data-aos-duration="500"
              >
                <Image src="/home/col-two-img3.png" alt="girl" width={600} height={500} className=" w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="w-mainRow -ml-2.5 py-16 flex items-center z-1 relative md:flex-wrap md:w-full md:ml-0 featured md:py-12">
            <div
              ...
              data-aos-duration="500"
            >
              <h3><span className="text_gradient text-[35px] leading-[46px] tablet:text-[30px] tablet:leading-[42px] md:text-[27px] md:leading-[40px]">CMS Support & maintenance</span></h3>
              <p className="mt-5 text-black">
              ...
              <Link href="/cms-support" className=" mt-5 bgWhiteBtn gradient-btn mx-auto"><span>Learn More</span></Link>
            </div>
            <div className="content imageWrap-outer w-halfWidth mx-2.5 md:w-full md:mx-0">
              <div
                className="imageWrap w-full h-[458px] tablet:h-[280px] sm:h-[260px] relative overflow-hidden rounded-[30px]  before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-transparent before:border-bordergradient2 before:border-[7px] before:z-10 before:border-solid before:rounded-[30px]"
                ...
                data-aos-duration="500"
              >
                <Image src="/home/col-two-img4.png" alt="girl" width={600} height={500} className=" w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="container">
          <div className="w-full max-w-[600px] mx-auto">
            <h2 className="text-white  text-[65px] font-semibold  desktop:text-[42px] tablet:text-[36px] md:text-[32px]">Our values</h2>
          </div>
        </div>
      </section>
          ...
          <div className="w-mainRow -ml-2.5 flex flex-wrap items-center z-1 relative md:w-full md:ml-0">
            ...
            >
              <div className="icon-wrap mx-auto max-w-[41px] h-[41px] before:content-[''] relative mt-[15px] mb-9 before:absolute before:left-[-15px] before:top-[-15px] before:w-iconBeforeW before:h-iconBeforeH before:bg-[#ffffff2b] before:rounded-[15px] before:transition-colors before:duration-500 hover:before:bg-purplePink">
                <Image src="/icon-star.svg" alt="icon" width={45} height={45} className="w-full h-full object-contain relative z-10" />
              </div>
            ...
            >
              <div className="icon-wrap mx-auto max-w-[41px] h-[41px] before:content-[''] relative mt-[15px] mb-9 before:absolute before:left-[-15px] before:top-[-15px] before:w-iconBeforeW before:h-iconBeforeH before:bg-[#ffffff2b] before:rounded-[15px] before:transition-colors before:duration-500 hover:before:bg-purplePink">
                <Image src="/icon-partnership.svg" alt="icon" width={45} height={45} className="w-full h-full object-contain relative z-10" />
              </div>
            ...
            >
              <div className="icon-wrap mx-auto max-w-[41px] h-[41px] before:content-[''] relative mt-[15px] mb-9 before:absolute before:left-[-15px] before:top-[-15px] before:w-iconBeforeW before:h-iconBeforeH before:bg-[#ffffff2b] before:rounded-[15px] before:transition-colors before:duration-500 hover:before:bg-purplePink">
                <Image src="/icon-certificate.svg" alt="icon" width={45} height={45} className="w-full h-full object-contain relative z-10" />
              </div>
              <h5 className="text-white">Commitment to excellence</h5>
              <p className="mt-4 text-[15px] text-lightGray leading-[26px]">
              Excellence is not just a principle; it's the essence of Bright Code. We infuse it into the interactions with our clients.
              </p>
            </div>
            <div
              className="content w-colFour mx-2.5 mb-10  text-spaceBlack xl:w-halfWidth md:!w-full md:mx-0 md:mb-0 md:px-0 text-center"
            ...
            >
             <div className="icon-wrap mx-auto max-w-[41px] h-[41px] before:content-[''] relative mt-[15px] mb-9 before:absolute before:left-[-15px] before:top-[-15px] before:w-iconBeforeW before:h-iconBeforeH before:bg-[#ffffff2b] before:rounded-[15px] before:transition-colors before:duration-500 hover:before:bg-purplePink">
                <Image src="/icon-idea.svg" alt="icon" width={45} height={45} className="w-full h-full object-contain relative z-10" />
              </div>
          ...
          <div className="w-mainRow -ml-2.5 flex md:flex-wrap md:w-full md:ml-0">
            <div className="w-halfWidth mx-2.5 md:w-full md:mx-0 md:mb-10">
              <h4 className="text-white text-[23px] md:text-[20px] xl-up:leading-10 ">
                If you are interested in learning more about Bright Code and how
                we can work together to achieve your goals, we encourage you to
                get in touch with us directly. 
              </h4>
              <br />
              <h5 className="text-white font-light">
              We value direct, one-on-one
                discussions where we can understand your unique needs and
