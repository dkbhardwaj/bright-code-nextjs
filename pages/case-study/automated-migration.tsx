    ...
    <>
      ...
      <section
        ...
        <div className="container">
          <div className="w-full z-1 relative">
            <div className="content w-full text-center relative">
              <h6 className="title text-[#8000FF] uppercase font-normal mb-3 md:mb-1">The Solution</h6>
          ...
          <div className="w-mainRow -ml-2.5 flex flex-wrap sm:w-full sm:ml-0">
              ...
              <div className="card bg-white h-full ">
                ...
                <div className="textWrap py-9 px-5 md:py-5 sm:px-0 ">
                  <p className=" text-black line-clamp-[10] overflow-hidden text-overflow-ellipsis ">
                    The insurer was already using Moody’s RMS catastrophe models across its business, which were
                    embedded into its underwriting and corporate management process. However, “bending its EP curve”
                    would not deliver the insights needed to capture future climate change risk and drive strategic
                    decision-making. While the insurer was an industry leader in understanding and quantifying.
                  </p>
                </div>
              </div>
            </div>
            <div
              ...
              <div className="card bg-white h-full">
                ...
                <div className="textWrap py-9 px-5 md:py-5 sm:px-0 ">
                  <p className=" text-black line-clamp-[10] overflow-hidden text-overflow-ellipsis ">
                    The project kicked off looking at North American Hurricane and Australian Cyclone, assessing three
                    specific time horizons: 2030, 2050 and 2100. Moody’s RMS analysts worked with the carrier’s internal
                    catastrophe modeling and exposure management team, analyzing a Representative Concentration Pathway
                    (RCP) scenario for future greenhouse gas concentrations awrad...
                  </p>
                </div>
              </div>
            </div>
            <div
              ...
              <div className="card bg-white h-full">
                ...
                <div className="textWrap py-9 px-5 md:py-5 sm:px-0 ">
                  <p className=" text-black line-clamp-[10] overflow-hidden text-overflow-ellipsis ">
                    The company felt Moody’s RMS was best positioned to interpret scientific consensus around climate
                    change and its likely impact on physical risk from natural perils. Working with Moody’s RMS also
                    offered stakeholders an "external seal of approval," enabling the organization to demonstrate that
                    it had worked with industry-leading analysts and taken concrete steps to build a clear view of how
                    climate change...
                  </p>
                </div>
              </div>
      ...
      <section
        ...
        <div className="container">
          <div className="w-full z-1 relative">
            <div className="content w-full text-center relative">
              <h6 className="title text-[#8000FF] uppercase font-normal mb-3 md:mb-1">The Outcome</h6>
              <h2 className="font-medium text-black ">Clarity Around Climate Change and its Impact on the Portfolio</h2>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="w-mainRow -ml-2.5 py-16 flex items-center z-1 relative md:flex-wrap md:w-full md:ml-0  md:py-12">
            <div
              ...
              data-aos-duration="500">
              <p className=" text-black">
                The new insights were critical to increasing confidence with shareholders and supporting business
                planning. The ability to effectively communicate climate change risk using traditional industry loss
                metrics, such as average annual loss, helped the insurer’s senior leadership team gain instant
                credibility with shareholders. Furthermore, with both a near- and long-term view of climate risk, they
                were able to plan more effectively for the uncertainty that climate change brings to their book of
                business.
              </p>
              <p className="mt-5  text-black">
                Equipped with insights based on multiple climate change scenarios, the insurer is building new
                capabilities to operationalize climate change science to meet the new and emerging business and
                regulatory challenges. Next steps include licensing the new Moody’s RMS climate change models for
                European Windstorm, North Atlantic Hurricane, and European Flood risk. With these new models that embed
                into their view of risk, the company can now easily incorporate climate change insights across different
                time horizons into their existing workflows.
              </p>
            </div>
            <div className="content imageWrap-outer w-halfWidth mx-2.5 md:w-full md:mx-0">
              <div
        ...
        <div className="container">
          <div className="intro_content">
            ...
            <p className=" text-black mb-[45px] lg:mb-[30px] md:!mb-5">
              The insurer was already using Moody’s RMS catastrophe models across its business, which were embedded into
              its underwriting and corporate management process. However, “bending its EP curve” would not deliver the
              insights needed to capture future climate change risk and drive strategic decision-making. While the
              insurer was an industry leader in understanding and quantifying.
            </p>
            <p className=" text-black mb-[45px] lg:mb-[30px] md:!mb-5">
              The project kicked off looking at North American Hurricane and Australian Cyclone, assessing three
              specific time horizons: 2030, 2050 and 2100. Moody’s RMS analysts worked with the carrier’s internal
              catastrophe modeling and exposure management team, analyzing a Representative Concentration Pathway (RCP)
              scenario for future greenhouse gas concentrations awrad...
            </p>
            <p className=" text-black ">
              The company felt Moody’s RMS was best positioned to interpret scientific consensus around climate change
              and its likely impact on physical risk from natural perils. Working with Moody’s RMS also offered
              stakeholders an "external seal of approval," enabling the organization to demonstrate that it had worked
              with industry-leading analysts and taken concrete steps to build a clear view of how climate change...
            </p>
          </div>
        </div>
      </section>
