...
const Herobanner: React.FC<HeroBannerData> = ({ data }) => {
  ...
  return (
    <section
      className={`${!foregroundVideo ? 'banner-with-img items-end' : 'items-center'} banner_overlay relative  overflow-x-hidden bg-darkBlue flex  text-white z-[1] pt-28 pb-24 min-h-[752px] desktop:min-h-[630px]  tablet:min-h-[560px] tablet:pt-24 tablet:pb-14 md:min-h-[552px]  md:pt-24 md:pb-12 md:items-center `}
    >
      {backgroundImage && (
